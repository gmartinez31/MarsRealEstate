...
interface MarsApiService {
    ...
    // @Query tells getProperties() (and thus Retrofit) to make a web service request w/ a filter option. Thus
    // everytime this method gets called, '?filter=type' gets appended to the request URL
